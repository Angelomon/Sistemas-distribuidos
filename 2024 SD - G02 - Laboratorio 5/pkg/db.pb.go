...
type ReplicaPut struct {
	...
	Clave string `protobuf:"bytes,1,opt,name=clave,proto3" json:"clave,omitempty"`
	Valor []byte `protobuf:"bytes,2,opt,name=valor,proto3" json:"valor,omitempty"`
	Lider string `protobuf:"bytes,3,opt,name=lider,proto3" json:"lider,omitempty"`
}

func (x *ReplicaPut) Reset() {
	*x = ReplicaPut{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_db_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReplicaPut) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplicaPut) ProtoMessage() {}

func (x *ReplicaPut) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_db_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplicaPut.ProtoReflect.Descriptor instead.
func (*ReplicaPut) Descriptor() ([]byte, []int) {
	return file_pkg_db_proto_rawDescGZIP(), []int{7}
}

func (x *ReplicaPut) GetClave() string {
	if x != nil {
		return x.Clave
	}
	return ""
...
func (x *ReplicaPut) GetValor() []byte {
	if x != nil {
		return x.Valor
	}
	return nil
...
func (x *ReplicaPut) GetLider() string {
	if x != nil {
		return x.Lider
	}
	return ""
...
func (x *ReplicaResponse) Reset() {
	*x = ReplicaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_db_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReplicaResponse) Descriptor() ([]byte, []int) {
	return file_pkg_db_proto_rawDescGZIP(), []int{8}
}
...
var file_pkg_db_proto_rawDesc = []byte{
	...
	,
}
...
var file_pkg_db_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_pkg_db_proto_goTypes = []interface{}{
	...
	(*ReplicaPut)(nil),      // 7: db.ReplicaPut
	(*ReplicaResponse)(nil), // 8: db.ReplicaResponse
}
var file_pkg_db_proto_depIdxs = []int32{
	...
	7, // 4: db.base.replicate:input_type -> db.ReplicaPut
	3, // 5: db.base.put:output_type -> db.ResultadoPut
	4, // 6: db.base.get:output_type -> db.ResultadoGet
	5, // 7: db.base.getAll:output_type -> db.ResultadoGetAll
	8, // 8: db.base.replicate:output_type -> db.ReplicaResponse
...
func file_pkg_db_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_db_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicaPut); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_db_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
