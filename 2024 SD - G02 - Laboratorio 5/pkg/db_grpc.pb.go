...
const (
	Base_Put_FullMethodName       = "/db.base/put"
	Base_Get_FullMethodName       = "/db.base/get"
	Base_GetAll_FullMethodName    = "/db.base/getAll"
	Base_Replicate_FullMethodName = "/db.base/replicate"
)
...
type BaseClient interface {
	...
	Replicate(ctx context.Context, in *ReplicaPut, opts ...grpc.CallOption) (*ReplicaResponse, error)
}
...
func (c *baseClient) Put(ctx context.Context, in *ParametroPut, opts ...grpc.CallOption) (*ResultadoPut, error) {
	...
	err := c.cc.Invoke(ctx, Base_Put_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *baseClient) GetAll(ctx context.Context, in *ParametroGetAll, opts ...grpc.CallOption) (*ResultadoGetAll, error) {
	...
	err := c.cc.Invoke(ctx, Base_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *baseClient) Replicate(ctx context.Context, in *ReplicaPut, opts ...grpc.CallOption) (*ReplicaResponse, error) {
	out := new(ReplicaResponse)
	err := c.cc.Invoke(ctx, Base_Replicate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BaseServer interface {
	...
	Replicate(context.Context, *ReplicaPut) (*ReplicaResponse, error)
...
func (UnimplementedBaseServer) Replicate(context.Context, *ReplicaPut) (*ReplicaResponse, error) {
...
func _Base_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Base_Put_FullMethodName,
	}
...
func _Base_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Base_GetAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Base_Replicate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReplicaPut)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BaseServer).Replicate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Base_Replicate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BaseServer).Replicate(ctx, req.(*ReplicaPut))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Base_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Base_Replicate_Handler,
		},
	},
